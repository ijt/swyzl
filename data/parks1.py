...
parks1 = models.PuzzleBook(
    name="Park Puzzlers - Volume One",
    short_name='parks1',
...
for row in data:
  puzzle = models.Puzzle(cipher_text=row[0], solution=row[1], clue=row[2],
                         index=row[3], clue_word=row[4], book_short_name='parks1')
  puzzle.put()
